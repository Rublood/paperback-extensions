...
const Madara_1 = require("../lib/TheNetsky/extensions-generic/src/Madara");
const MangaOriginesParser_1 = require("./MangaOriginesParser");
...
},{"../lib/TheNetsky/extensions-generic/src/Madara":62,"./MangaOriginesParser":61,"paperback-extensions-common":14}],61:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaOriginesParser = void 0;
/* eslint-disable @typescript-eslint/explicit-module-boundary-types */
/* eslint-disable @typescript-eslint/no-explicit-any */
const MadaraParser_1 = require("../lib/TheNetsky/extensions-generic/src/MadaraParser");
const paperback_extensions_common_1 = require("paperback-extensions-common");
class MangaOriginesParser extends MadaraParser_1.Parser {
    ...
    parseChapterList($, mangaId, source) {
        ...
        for (const obj of $('li.wp-manga-chapter  ').toArray()) {
            ...
            const id = mangaId + '/' + ((_a = urlParts[5]) !== null && _a !== void 0 ? _a : '');
            const chapName = (_b = $('a', obj).first().text().trim()) !== null && _b !== void 0 ? _b : '';
            const chapNum = Number((_d = (_c = decodeURIComponent(id).match(/\D*(\d*\-?\d*)\D*$/)) === null || _c === void 0 ? void 0 : _c.pop()) === null || _d === void 0 ? void 0 : _d.replace(/-/g, '.'));
            let mangaTime;
            ...
            chapters.push(createChapter({
                id: id,
                mangaId: mangaId,
                langCode: (_e = source.languageCode) !== null && _e !== void 0 ? _e : paperback_extensions_common_1.LanguageCode.UNKNOWN,
...
exports.MangaOriginesParser = MangaOriginesParser;

},{"../lib/TheNetsky/extensions-generic/src/MadaraParser":64,"paperback-extensions-common":14}],62:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        ...
        this.requestManager = createRequestManager({
            ...
            interceptor: {
                interceptRequest: (request) => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    request.headers = Object.assign(Object.assign({}, ((_a = request.headers) !== null && _a !== void 0 ? _a : {})), Object.assign(Object.assign(Object.assign({}, (globalUA && { 'user-agent': yield this.getUserAgent() })), { 'referer': `${this.baseUrl}/` }), (request.url.includes('wordpress.com') && { 'Accept': 'image/avif,image/webp,*/*' })));
                    request.cookies = [
    ...
    getImageSrc(imageObj, source) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (source === null || source === void 0 ? void 0 : source.stateManager) {
                const HQthumb = yield (0, MadaraSettings_1.getHQThumbnailSetting)(source.stateManager);
                if (HQthumb) {
